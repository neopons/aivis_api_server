...
class AudioProcessor(object):
  ...
  def __init__(self, flags):
    ...
    if flags.data_dir:
      ...
      self.validation_list_dir = flags.validation_list_dir
      self.testing_list_dir = flags.testing_list_dir
      if flags.split_data:
  ...
  def prepare_data_index(self, silence_percentage, unknown_percentage,
    ...
    fv = open(self.data_dir+'/'+self.validation_list_dir, "r")
    validation_list = fv.readlines()
    ft = open(self.data_dir+'/'+self.testing_list_dir, "r")
    ...
    for wav_path in gfile.Glob(search_path):
      ...
      if word == du.BACKGROUND_NOISE_DIR_NAME:
        continue
      all_words[word] = True
      set_index = du.which_set_v2(wav_path, validation_list, testing_list)
