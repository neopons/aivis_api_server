...
def train(flags):
  ...
  if flags.model_name in ['crnn', 'gru', 'lstm', 'crnn_lgtfb', 'DNS_crnn', 'DNS_crnn_lgtfb', 'kws_transformer']:
  ...
  for training_step in range(start_step, training_steps_max + 1):
    ...
    #print(model.layers[0].output.eval())
    #print(model.layers[1].output.eval())
