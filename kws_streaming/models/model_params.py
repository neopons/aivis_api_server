...
def kws_transformer_params():
  """Parameters for kws_transformer"""
  params = Params()
  params.model_name = 'kws_transformer'
  params.num_layers = 8
  params.d_model = 128
  params.mlp_dim = 512
  params.heads = 4
  params.dropout1 = 0.1
  params.attention_type = 'time'
  params.patch_size = '1,40'
  params.prenorm = False
  params.approximate_gelu = False
  return params

def DNS_crnn_params():
  """Parameters for toy conv rnn model."""
  params = Params()
  params.model_name = 'DNS_crnn'
  params.cnn_filters = '4,4'
  params.cnn_kernel_size = '(3,3),(1,1)'
  params.cnn_act = "'relu','relu'"
  params.cnn_dilation_rate = '(1,1),(1,1)'
  params.cnn_strides = '(1,1),(1,1)'
  params.gru_units = '4'
  params.return_sequences = '1'
  params.dropout1 = 0.1
  params.units1 = '4,4'
  params.act1 = "'linear','relu'"
  params.stateful = 0
  params.dtln_units = '128'
  params.dtln_num_layer = '2'
  params.dtln_blockLen = '512'
  params.dtln_block_shift = '128'
  params.dtln_encoder_size = '256'
  params.dtln_dropout = 0.25
  params.dtln_activation = 'sigmoid'
  return params
...
HOTWORD_MODEL_PARAMS = {
    ...
    'kws_transformer': kws_transformer_params(),
    'DNS_crnn': DNS_crnn_params()
}
